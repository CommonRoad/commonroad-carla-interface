...
class CommonRoadPlannerController(CarlaController):
    ...
    def __init__(self, actor: carla.Actor, planner: TrajectoryPlannerInterface, pp: PlanningProblem, sc: Scenario,
