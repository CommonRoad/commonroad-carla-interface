...
from carlacr.visualization.canvas.ui_elements.text import Text, COLOR_WHITE, COLOR_RED
...
class CanvasController(VisualizationBase):
    ...
    def __init__(self, vis3d: 'Visualization3D', z_axis: float = 100) -> None:
        ...
        self._notification_text = FadingText(FadingText.font_mono(), (self._vis3d.config.width, 40),
    ...
    def _create_info_text(self):
        ...
        info_text = [f'Server:  {self._vis3d.server_fps:.2f} FPS', f'Client:  {self._vis3d.client_fps:.2f} FPS', '',
                     f'Vehicle: {get_actor_display_name(self._vis3d.ego_vehicle, truncate=20)}', f'Map:     {map_name}',
        ...
        if isinstance(c, carla.VehicleControl):
            ...
            info_text += [('Throttle:', c.throttle, 0.0, 1.0), ('Steer:', c.steer, -1.0, 1.0),
