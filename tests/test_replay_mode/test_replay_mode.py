...
class TestReplayMode(unittest.TestCase):
    def test_replay_mode(self, scenario_file: str = 'scenarios/DEU_Test-1_1_T-1.xml',
        ...
        replay = \
            CarlaReplayMode(open_drive_map_path=os.path.dirname(os.path.abspath(__file__)) + "/../../" + map_file,
        ...
        try:
            ...
            self.fail(f"replay mode failed to create object with scenario {scenario_file}, "
                      f"map {map_file} and exception {e}")
