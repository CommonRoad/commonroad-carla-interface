...
or_map_path = os.path.join(parent_dir, 'maps', 'four_way_crossing.xodr')
# cr_scenario_path = os.path.join(parent_dir, 'maps', 'Town10HD.xml')

cr_scenario_path = os.path.join(parent_dir, 'scenarios', 'four_way_crossing_Modi.xml')
